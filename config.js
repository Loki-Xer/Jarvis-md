...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_9385_3648_1a71_2a2f_275d_a1e8_dec7_0918',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '𝐷𝐴𝑅𝐸  𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡;ᴡᴀʙᴏᴛ',
  ...
  SUDO: process.env.SUDO || '254103524425,919832962298',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || '𝐷𝐴𝑅𝐸  𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡;ʟᴏᴋɪ-xᴇʀ;https://i.imgur.com/VIpl3q5.mp4',
