...
module.exports = {
  ...
  READ_MSG: toBool(process.env.READ_MSG || "false"),18590822912
  BRANCH: "main",
  KOYEB_API: process.env.KOYEB_API,
  BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
  TGTOKEN: "bot891038791:AAHWB1dQd-vi0IbH2NjKYUk-hqQ8rQuzPD4",
  API: 'https://api.lokiser.xyz/',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || ';© ᴍᴜɴᴀᴠɪʀ',
  ...
  SUDO: process.env.SUDO || '2348060585869,9',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'ᴊ ᴏ ᴊᴏ;ᴍᴜɴᴀᴠɪʀ;https://i.imgur.com/WFFp432.mp4',
